...
@__app_environment_variables_v_3.7 = internal constant [37 x i8] c"0f14a1fc-f481-4a9f-a25c-f731cbda8ecb\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [21 x i8] c"com.companyname.todo\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 353, ; number_of_assemblies_in_apk
	i32 70, ; bundled_assembly_name_width
	i32 2, ; number_of_assembly_store_files
	i32 40, ; number_of_dso_cache_entries
	i32 33560109, ; android_runtime_jnienv_class_token
	i32 100762565, ; jnienv_initialize_method_token
	i32 100762564, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.2 = internal constant [26 x i8] c"libgrpc_csharp_ext.x64.so\00", align 1
@__DSOCacheEntry_name.3 = internal constant [50 x i8] c"libSystem.Security.Cryptography.Native.Android.so\00", align 1
@__DSOCacheEntry_name.4 = internal constant [28 x i8] c"libgrpc_csharp_ext.arm64.so\00", align 1
...
@dso_cache = local_unnamed_addr global [40 x %struct.DSOCacheEntry] [
	...
	; 1
	%struct.DSOCacheEntry {
		i64 748159497906356867, ; hash 0xa61ff19740b0283, from name: libgrpc_csharp_ext.x64.so
		i8 0, ; ignore
	...
	; 3
	%struct.DSOCacheEntry {
		i64 2208344972884956339, ; hash 0x1ea59e0d7253d4b3, from name: grpc_csharp_ext.arm64
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 4
	%struct.DSOCacheEntry {
	...
	; 14
	%struct.DSOCacheEntry {
		i64 7550351285106544967, ; hash 0x68c83c7d86309147, from name: grpc_csharp_ext.arm64.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 18
	%struct.DSOCacheEntry {
		i64 8111232044597331512, ; hash 0x7090e291c4fd4638, from name: grpc_csharp_ext.x64.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 27
	%struct.DSOCacheEntry {
		i64 14708867851741753982, ; hash 0xcc206561573af27e, from name: libgrpc_csharp_ext.arm64
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 30
	%struct.DSOCacheEntry {
		i64 16508196147187764690, ; hash 0xe518e4ee83994dd2, from name: grpc_csharp_ext.x64
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 33
	%struct.DSOCacheEntry {
		i64 17474041403958087734, ; hash 0xf28044135163d036, from name: libgrpc_csharp_ext.arm64.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 35
	%struct.DSOCacheEntry {
		i64 17861066555782226523, ; hash 0xf7df41668702625b, from name: libgrpc_csharp_ext.x64
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
...
@bundled_assemblies = local_unnamed_addr global [353 x %struct.XamarinAndroidBundledAssembly] [
	; 0
...
!6 = !{!"Xamarin.Android remotes/origin/release/7.0.1xx-rc2 @ bf10ce5525d97f2303993d631003df54f2837617"}
